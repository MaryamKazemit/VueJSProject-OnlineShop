<template>
  <!-- new products -->
  <div class="container mt-4 widecontent">
    <!-- title -->
    <div class="border-bottom">
      <h3 class="font-iran-mid test" dir="rtl">محصولات جدید</h3>
    </div>
    <swiper
        :autoplay="{
          delay: 2500,
        ...
        :modules="modules"
        class="mySwiper mt-4">
      <swiper-slide v-for="product in products" class="card m-2 align-items-center d-flex product" style="width: 18rem;"
                    dir="rtl">
        ...
        <div class="card-body border-top ms-3 me-3">
          ...
          <div class="card-text font-iran-mid mt-2">
            <span class="font-iran-sm product-price"
                  :data-price="product.productPrice">{{ product.productPrice }}</span>
            <span>توما</span>
